...
class Position:
    ...
    def calculate_position(self, time):
        ...
        # cal spot commission
        # Todo: convert this to usdt as it's currently in the transacting coin (e.g. APE)
        ...
        self.closing_profit_loss = (
            self.futures_closing_profit_loss + self.spot_closing_profit_loss
        )
